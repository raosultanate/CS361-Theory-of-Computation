...
/**
 * This class represents the entire DFA machine. It implements DFAInterface
 * uses the DFAState class to represent each state.
...
public class DFA implements fa.dfa.DFAInterface {
    ...
    /**
     * Returns the state if it exists in the stateSet by looping through and checking its name
     * @param name	Name of state to be retrieved 
     * @return
     */
